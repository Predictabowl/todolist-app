...
class VerificationHelperServiceImplTest {
	...
	@Mock
	private CreateOrReplaceVerificationTokenUsePort createToken;
	...
	void test_verificationBuildingProcedure() throws URISyntaxException {
		...
		VerificationLinkDTO linkDto = new VerificationLinkDTO(FIXTURE_BASE_URL+"/"+FIXTURE_TOKEN, FIXTURE_EMAIL);  
